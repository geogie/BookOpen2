package com.george.bookopen.book3;
 ...
 * Description:
 */
public class BookOpenView3 extends FrameLayout implements Animator.AnimatorListener {
    ...
    public BookOpenView3(@NonNull Context context) {
        super(context, null, 0);
        initView(context);
    }

    public BookOpenView3(@NonNull Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BookOpenView3(@NonNull Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
